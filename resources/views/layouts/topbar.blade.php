            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="{{ url('/') }}">
                        ...
                        <!--This is dark logo icon--><img src="{{ asset('plugins/images/admin-logo.png')}}" alt="home" class="dark-logo" /><!--This is light logo icon-->
                ...
                <ul class="nav navbar-top-links navbar-left">
                                ...
                                <div class="message-center">
                                    <a href="#">
                                        ...
                                        <div class="mail-contnet">
                                            <h5>CAA</h5> <span class="mail-desc">Welcome to Criminal Alerts App</span> <span class="time">9:02 AM</span> </div>
                                    </a>
                                </div>
                            </li>
                            <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-tasks animated slideInUp">
                            <li>
                                <a href="#">
                                    <div>
                                        <p> <strong>Crime Group</strong> <span class="pull-right text-muted">40% chance</span> </p>
                    ...
                    {{-- Deletet the mega menu from here, just incase I need to review it later --}}
                </ul>
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="{{ asset('plugins/images/users/varun.jpg')}}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">
                        {{-- {{ Auth::user()->name }}     --}}
